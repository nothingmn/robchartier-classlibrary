...
namespace RobChartier.Network.SNTP
{
    ...
    public class NTPClient
    {
        ...
        public static RobChartier.Network.SNTP.NTPClient GetTime(string TimeServer)
        {
            RobChartier.Network.SNTP.NTPClient client = new RobChartier.Network.SNTP.NTPClient(TimeServer);
            client.Connect();
            return client;
        }
        public static RobChartier.Network.SNTP.NTPClient GetTime()
        {
